...
const PythagorasVisualizationGraph = () => {
  ...
  const updateBoard = (board) => {
    ...
    if (showSideLengths) {
      ...
      const heightLabelOffset = Math.max(0.3, height * 0.08);
    ...
    <div className="pythagoras-visualization space-y-4">
      ...
      <div className="flex flex-wrap justify-center p-4 bg-gray-50 rounded-lg gap-4">
        <button
          ...
          className={`px-3 py-2 rounded-md flex items-center ${showLabels ? `bg-${theme.secondary} text-${theme.secondaryText}` : 'bg-gray-100 text-gray-500'
        ...
        <button
          ...
          className={`px-3 py-2 rounded-md flex items-center ${showSideLengths ? `bg-${theme.secondary} text-${theme.secondaryText}` : 'bg-gray-100 text-gray-500'
            } hover:opacity-80 transition-colors`}
        ...
        <button
          ...
          className={`px-3 py-2 rounded-md flex items-center ${showHint ? `bg-${theme.secondary} text-${theme.secondaryText}` : 'bg-gray-100 text-gray-500'
            } hover:opacity-80 transition-colors`}
