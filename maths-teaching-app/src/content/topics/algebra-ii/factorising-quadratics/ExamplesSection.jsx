// src/content/topics/algebra-ii/factorising-quadratics/ExamplesSection.jsx
// Examples Section for Factorising Quadratic Expressions
// Three tabs: Simple (a=1), Difference of squares, Complex (a≠1)
            ...
            <div className="bg-orange-50 rounded-lg p-8 border-l-4 border-orange-400 mb-6">
              <div className="text-center">
                <div className="text-2xl">
                  <MathDisplay math={currentExample?.questionText?.replace(/^\$/, '').replace(/\$$/, '').replace('Factorise: ', '').replace(/\$/g, '')} displayMode={true} />
                </div>
              </div>
            </div>
            {showAnswers && currentExample?.solution && (
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <h5 className="font-medium text-purple-800 mb-2">Key Methods</h5>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-center">
                    <div>
                      <p className="font-medium text-purple-700">Simple (a = 1)</p>
                      <p className="text-purple-600 mt-1">Find factors of c that sum to b</p>
                    </div>
                    <div>
                      <p className="font-medium text-purple-700">Difference of Squares</p>
                      <MathDisplay math="a^2 - b^2 = (a+b)(a-b)" />
                    </div>
                    <div>
                      <p className="font-medium text-purple-700">Complex (a ≠ 1)</p>
                      <p className="text-purple-600 mt-1">ac method or trial</p>
                    </div>
                  </div>
                </div>
              </div>
